...
public class PieceElephant extends Piece {
    ...
    public PieceElephant( Point position, int player, Echiquier echiquier ) {
        super( position, player, Animal.Elephant, echiquier, false );
    }

    public PieceElephant( Long id, Point point, int player, boolean trapped ) {
        super( id, point, player, Animal.Elephant, trapped );
    }
                ...
                if ( piece != null ) {
                    ...
                    // traped ne mange jamais
                        ...
                        possibleMoves.remove( possibleMoves.get( compteur ) );
                            ...
                            && piece.getAnimal().toString().equals( Animal.Rat.toString() ) ) {
                        System.out.println( "Elephant ne mange pas un Rat" );
                        possibleMoves.remove( possibleMoves.get( compteur ) );
                    }
