...
public class PieceLion extends Piece {

    public PieceLion( Point position, int player, Echiquier echiquier ) {
        super( position, player, Animal.Lion, echiquier, false );
    }

    public PieceLion( Long id, Point point, int player, boolean trapped ) {
        super( id, point, player, Animal.Lion, trapped );
    }
