...
public class PieceChat extends Piece {

    public PieceChat( Point position, int player, Echiquier echiquier ) {
        super( position, player, Animal.Chat, echiquier, false );
    }

    public PieceChat( Long id, Point point, int player, boolean trapped ) {
        super( id, point, player, Animal.Chat, trapped );
    }
