...
public class PiecePanthere extends Piece {

    public PiecePanthere( Point position, int player, Echiquier echiquier ) {
        super( position, player, Animal.Panthere, echiquier, false );
    }

    public PiecePanthere( Long id, Point point, int player, boolean trapped ) {
        super( id, point, player, Animal.Panthere, trapped );
    }
